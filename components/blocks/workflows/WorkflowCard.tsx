      ...
      <CardContent className="p-4 flex items-center justify-between h-[100px]">
        ...
        <div className="">
          <h3 className=" text-base font-bold text-muted-foreground flex items-center ">
            ...
            {isDraft && (
              <span className="ml-2 px-2 py-0.5 text-xs font-medium bg-yellow-100 text-yellow-800 rounded-md ">
                Draft
              </span>
            )}
          </h3>
...
function WorkflowActions(props: { workflowName: string; workflowId: string }) {
